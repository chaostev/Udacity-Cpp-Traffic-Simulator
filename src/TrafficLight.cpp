...
void TrafficLight::waitForGreen()
{
	...
	while (true) {
		TrafficLightPhase msg = _lightQueue.receive();
    ...
    // Also, the while-loop should use std::this_thread::sleep_for to wait 1ms between two cycles. 
  	...
  	while (true) {
		...
		auto duration = std::chrono::milliseconds(cycle_dist(generator));
      	...
      	// NOTE: I do not std::move _currentPhase, because I would like to use
		// both this variable and the MessageQueue<TrafficLightPhase> later
