...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // NOTE: using MessageQueue has some latency blocking cars with a red light (some cars slip through).
    //  However checking _currentPhase directly has much better performance (example code below).
    //  I think there might be extra elements getting in the deque?
  	//  But adding a _queue.clear() right before _queue.push_back() didn't help...
  	//  Or is this performance normal?
    //
